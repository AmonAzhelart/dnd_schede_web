...
import { FaHeart, FaBolt, FaStar, FaBook, FaCoins, FaLanguage } from 'react-icons/fa';
import {
    GiSwordman, GiAxeSword, GiSpellBook, GiTreasureMap, GiWalk,
    GiHealthPotion, GiShield, GiBrain,
} from 'react-icons/gi';
...
import { ClassFeaturesWidget } from './ClassFeaturesWidget';
import { FeatsWidget } from './FeatsWidget';
...
export const WIDGET_CATALOG: WidgetDefinition[] = [
    { id: 'hp', title: 'Punti Ferita', description: 'HP correnti, max, temporanei', icon: <FaHeart />, defaultW: 3, defaultH: 4, minW: 2, minH: 3, render: HpWidget, accent: 'var(--accent-crimson)' },
    ...
    { id: 'classFeatures', title: 'Privilegi di Classe', description: 'Lista privilegi e risorse', icon: <FaBook />, defaultW: 3, defaultH: 6, minW: 2, minH: 3, render: ClassFeaturesWidget, accent: 'var(--accent-gold)' },
    { id: 'feats', title: 'Talenti', description: 'Talenti del personaggio', icon: <FaBolt />, defaultW: 3, defaultH: 6, minW: 2, minH: 3, render: FeatsWidget, accent: 'var(--accent-arcane)' },
...
export const getWidgetDef = (id: string) => WIDGET_CATALOG.find(w => w.id === id);
